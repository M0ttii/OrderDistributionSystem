                ...
                <div class="col-sm-6">
                  <div class="blog box_shadow">
                    ...
                    <div class="blog_content">
                      <a href="http://ah-theme.com/moby/moby/blogs-rightside.html#">
            ...
            <div class="col-md-12 col-lg-4">
              <aside class="aside-sec">
                <form class="form-inline search-form">
                  <input class="search-input w-100" type="search" placeholder="Search..." aria-label="Search">
                  <button class="search-btn bg_grad" type="submit"><svg class="svg-inline--fa fa-search fa-w-16" aria-hidden="true" data-prefix="fas" data-icon="search" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M505 442.7L405.3 343c-4.5-4.5-10.6-7-17-7H372c27.6-35.3 44-79.7 44-128C416 93.1 322.9 0 208 0S0 93.1 0 208s93.1 208 208 208c48.3 0 92.7-16.4 128-44v16.3c0 6.4 2.5 12.5 7 17l99.7 99.7c9.4 9.4 24.6 9.4 33.9 0l28.3-28.3c9.4-9.4 9.4-24.6.1-34zM208 336c-70.7 0-128-57.2-128-128 0-70.7 57.2-128 128-128 70.7 0 128 57.2 128 128 0 70.7-57.2 128-128 128z"></path></svg><!-- <i class="fas fa-search"></i> --></button>
                </form>
                <div class="catigories">
                  <h3>Categories</h3>
                  <ul>
                    <li class="cat_item"><a href="http://ah-theme.com/moby/moby/blogs-rightside.html#">All Topics <svg class="svg-inline--fa fa-chevron-right fa-w-10 float-right col_purple" aria-hidden="true" data-prefix="fas" data-icon="chevron-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg=""><path fill="currentColor" d="M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z"></path></svg><!-- <i class="fas fa-chevron-right float-right col_purple"></i> --></a></li>
                    <li class="cat_item"><a href="http://ah-theme.com/moby/moby/blogs-rightside.html#">Appik <svg class="svg-inline--fa fa-chevron-right fa-w-10 float-right col_purple" aria-hidden="true" data-prefix="fas" data-icon="chevron-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg=""><path fill="currentColor" d="M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z"></path></svg><!-- <i class="fas fa-chevron-right float-right col_purple"></i> --></a></li>
                    <li class="cat_item"><a href="http://ah-theme.com/moby/moby/blogs-rightside.html#">Merchant Service <svg class="svg-inline--fa fa-chevron-right fa-w-10 float-right col_purple" aria-hidden="true" data-prefix="fas" data-icon="chevron-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg=""><path fill="currentColor" d="M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z"></path></svg><!-- <i class="fas fa-chevron-right float-right col_purple"></i> --></a></li>
                    <li class="cat_item"><a href="http://ah-theme.com/moby/moby/blogs-rightside.html#">Trader Service <svg class="svg-inline--fa fa-chevron-right fa-w-10 float-right col_purple" aria-hidden="true" data-prefix="fas" data-icon="chevron-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg=""><path fill="currentColor" d="M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z"></path></svg><!-- <i class="fas fa-chevron-right float-right col_purple"></i> --></a></li>
                    <li class="cat_item"><a href="http://ah-theme.com/moby/moby/blogs-rightside.html#">Acount Payment <svg class="svg-inline--fa fa-chevron-right fa-w-10 float-right col_purple" aria-hidden="true" data-prefix="fas" data-icon="chevron-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg=""><path fill="currentColor" d="M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z"></path></svg><!-- <i class="fas fa-chevron-right float-right col_purple"></i> --></a></li>
                  </ul>
                </div>
                <div class="latest-news">
                  <h3>Latest News</h3>
                  <div class="news_item d-flex justify-content-start align-content-center align-items-center">
                    <div class="news_img">
                      <img src="../../public/images/news.jpg" alt="news-picture">
                    </div>
                    <a href="http://ah-theme.com/moby/moby/blogs-rightside.html#">
                      <div class="news-content">
                        <p class="news_tit text-uppercase">Simply dummy text of the printing</p>
                        <p class="date col_purple">Apr 13, 2018</p>
                      </div>
                    </a>
                  </div>
                  <div class="news_item d-flex justify-content-start align-content-center align-items-center">
                    <div class="news_img">
                      <img src="{{ asset('images/blog2.jpg') }}" alt="news-picture">
                    </div>
                    <a href="http://ah-theme.com/moby/moby/blogs-rightside.html#">
                      <div class="news-content">
                        <p class="news_tit text-uppercase">Simply dummy text of the printing</p>
                  ...
                  <div class="news_item d-flex justify-content-start align-content-center align-items-center">
                    <div class="news_img">
                      <img src="{{ asset('images/blog1.jpg') }}" alt="news-picture">
                    </div>
                    <a href="http://ah-theme.com/moby/moby/blogs-rightside.html#">
                      <div class="news-content">
                        <p class="news_tit text-uppercase">Simply dummy text of the printing</p>
                  ...
                  <div class="news_item d-flex justify-content-start align-content-center align-items-center">
                    <div class="news_img">
                      <img src="{{ asset('images/blog3.jpg') }}" alt="news-picture">
                    </div>
                    <a href="http://ah-theme.com/moby/moby/blogs-rightside.html#">
                      <div class="news-content">
                        <p class="news_tit text-uppercase">Simply dummy text of the printing</p>
